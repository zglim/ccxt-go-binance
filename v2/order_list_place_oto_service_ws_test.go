...
func (s *orderListPlaceOtoServiceWsTestSuite) TestOrderListPlaceOto_ErrorBranches() {
	s.assertDoErrorBranches(s.reset, func(reqID string) error {
		return s.orderListPlaceOto.Do(reqID, s.orderListPlaceOtoRequest)
	})
}
...
func (s *orderListPlaceOtoServiceWsTestSuite) TestOrderListPlaceOtoSync_ErrorBranches() {
	s.assertSyncDoErrorBranches(s.reset, func(reqID string) (interface{}, error) {
		return s.orderListPlaceOto.SyncDo(reqID, s.orderListPlaceOtoRequest)
	})
}
