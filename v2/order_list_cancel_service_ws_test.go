...
func (s *orderListCancelServiceWsTestSuite) SetupTest() {
	s.initScaffold("c5899911-d3f4-47ae-8835-97da553d27d0")
...
func (s *orderListCancelServiceWsTestSuite) TestOrderListCancel_ErrorBranches() {
	s.assertDoErrorBranches(s.reset, func(reqID string) error {
		return s.orderListCancel.Do(reqID, s.orderListCancelRequest)
	})
}
...
func (s *orderListCancelServiceWsTestSuite) TestOrderListCancelSync_ErrorBranches() {
	s.assertSyncDoErrorBranches(s.reset, func(reqID string) (interface{}, error) {
		return s.orderListCancel.SyncDo(reqID, s.orderListCancelRequest)
	})
}
